  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[600px] overflow-hidden mt-20">
        <img
          src="https://images.unsplash.com/photo-1547621008-d6d6d2e28e81?q=80&w=1080"
          alt="Digital Marketing"
          className="absolute inset-0 w-full h-full object-cover"
        />
        {/* Gradient changed from Orange/Red to Emerald/Teal */}
        ...
        <div className="container mx-auto px-4 lg:px-8 h-full relative z-10 flex items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold tracking-wide">MARKETING SERVICE</span>
            </div>
            ...
            <p className="text-2xl text-white/90 leading-relaxed mb-8">
              Drive leads, conversions & brand visibility with comprehensive digital marketing strategies. Grow your brand and reach your target audience.
            </p>
      ...
      {/* Features Section - Emerald Checkmarks & Hover States */}
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-12 text-white shadow-2xl shadow-emerald-200/50">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">Ready to Grow Your Brand?</h2>
              <p className="text-xl text-white/90 mb-8 leading-relaxed">Let's discuss how we can help boost your digital presence and drive measurable results.</p>
