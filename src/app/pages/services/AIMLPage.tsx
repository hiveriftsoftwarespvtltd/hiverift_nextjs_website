...
export function AIMLPage() {
  ...
  const technologies = ["TensorFlow", "PyTorch", "Scikit-learn", "OpenAI", "Hugging Face", "CUDA"];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[600px] overflow-hidden mt-20">
        <img
          src="https://images.unsplash.com/photo-1717501218504-81ed5eb52cd0?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhcnRpZmljaWFsJTIwaW50ZWxsaWdlbmNlJTIwbmV1cmFsJTIwbmV0d29ya3xlbnwxfHx8fDE3NzA3ODIxOTl8MA&ixlib=rb-4.1.0&q=80&w=1080"
          alt="AI & Machine Learning"
          className="absolute inset-0 w-full h-full object-cover"
        />
        {/* Gradient updated to Emerald Reference */}
        ...
        <div className="container mx-auto px-4 lg:px-8 h-full relative z-10 flex items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold tracking-wide">AI & DATA SERVICE</span>
            </div>
            ...
            <p className="text-2xl text-white/90 leading-relaxed mb-8">
              Intelligent AI solutions that automate processes and deliver data-driven insights. Harness the power of artificial intelligence.
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-12 text-white shadow-2xl shadow-emerald-200/50">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">Ready to Implement AI?</h2>
              <p className="text-xl text-white/90 mb-8 leading-relaxed">Let's discuss how we can help transform your business with custom-built intelligent solutions.</p>
