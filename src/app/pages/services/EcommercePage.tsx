...
export function EcommercePage() {
  ...
  const technologies = ["Shopify", "WooCommerce", "Magento", "Stripe", "PayPal", "Custom Solutions"];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[600px] overflow-hidden mt-20">
        <img
          src="https://images.unsplash.com/photo-1658297063569-162817482fb6?q=80&w=1080"
          alt="E-Commerce Solutions"
          className="absolute inset-0 w-full h-full object-cover"
        />
        {/* Updated from green-900 to professional emerald/teal */}
        ...
        <div className="container mx-auto px-4 lg:px-8 h-full relative z-10 flex items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold tracking-wide uppercase">E-Commerce Service</span>
            </div>
            ...
            <p className="text-2xl text-white/90 leading-relaxed mb-8">
              Setup, optimize & grow online stores with seamless shopping experiences. Launch and scale your online business with robust platforms.
            </p>

            <Link to="/contact">
              <button className="px-8 py-4 bg-white text-emerald-900 rounded-full font-bold text-lg hover:bg-emerald-50 transition-all duration-300 hover:shadow-xl hover:scale-105 inline-flex items-center gap-2">
                Get Started
                <ArrowRight size={20} />
              </button>
            </Link>
      ...
      {/* Features Section - Emerald Icons */}
      ...
      {/* Technologies Section - Dark Emerald Background */}
      <section className="py-24 bg-gradient-to-br from-emerald-900 to-teal-900 text-white">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-12 text-white">Technologies We Use</h2>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-12 text-white shadow-2xl shadow-emerald-200/50">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">Ready to Launch Your Store?</h2>
              <p className="text-xl text-white/90 mb-8 leading-relaxed">Let's discuss how we can help build your high-converting e-commerce platform.</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/contact">
                  <button className="px-8 py-4 bg-white text-emerald-900 rounded-full font-bold text-lg hover:shadow-xl hover:scale-105 inline-flex items-center gap-2 transition-all">
                    Contact Us Today
                    <ArrowRight size={20} />
                  </button>
                </Link>
