...
export function DataAnnotationPage() {
  ...
  const technologies = ["LabelImg", "CVAT", "Labelbox", "Amazon SageMaker", "Custom Tools"];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[600px] overflow-hidden mt-20">
        <img
          src="https://images.unsplash.com/photo-1717501218504-81ed5eb52cd0?q=80&w=1080"
          alt="Data Annotation"
          className="absolute inset-0 w-full h-full object-cover"
        />
        {/* Cyan to Emerald Gradient update */}
        ...
        <div className="container mx-auto px-4 lg:px-8 h-full relative z-10 flex items-center">
          ...
          >
            ...
            <p className="text-2xl text-white/90 leading-relaxed mb-8">
              High-quality labeled datasets to train accurate and scalable AI models. Build AI models that actually work with professionally annotated training data.
            </p>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl p-12 text-white shadow-2xl shadow-emerald-200/50">
              <h2 className="text-4xl md:text-5xl font-bold mb-4">Ready to Annotate Your Data?</h2>
              <p className="text-xl text-white/90 mb-8 leading-relaxed">Let's discuss how we can help train your AI models with high-precision datasets.</p>
